...
VERSION=$(wget -qO- https://raw.githubusercontent.com/pocomx/peace/master/version/naiveproxy.txt | head -1 | tr -d [:space:])
wget -O /usr/bin/naive https://github.com/pocomx/peace/releases/download/${VERSION}/${NAIVE_FILE} > /dev/null 2>&1
